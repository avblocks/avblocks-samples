...
~~~ shell
./enc_aac_au_file --input ../assets/aud/equinox-48KHz.wav --output equinox-48KHz.au.aac
~~~
...
***
~~~ shell
mac:~/AVBlocksSDK.macosx/lib$ ./enc_aac_au_file --input ../assets/aud/equinox-48KHz.wav --output equinox-48KHz.au.aac
