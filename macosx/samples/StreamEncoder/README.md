...
The following command encodes a raw YUV video from `foreman_qcif.yuv` to a H.264 video in an MP4 container in `foreman_qcif.mp4`: 
	...
	./StreamEncoder --frame 176x144 --rate 30 --color yuv420 --input ../assets/vid/foreman_qcif.yuv --output foreman_qcif.mp4 --preset mp4.h264.aac

alternative using short option names:

	./StreamEncoder -f 176x144 -r 30 -c yuv420 -i ../assets/vid/foreman_qcif.yuv -o foreman_qcif.mp4 -p mp4.h264.aac
...
***
	...
	mac:~/AVBlocksSDK.macosx/lib$ ./StreamEncoder --frame 176x144 --rate 30 --color yuv420 --input ../assets/vid/foreman_qcif.yuv --output foreman_qcif.mp4 --preset mp4.h264.aac
