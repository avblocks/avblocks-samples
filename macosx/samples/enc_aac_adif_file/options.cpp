...
void setDefaultOptions(Options& opt)
{
    ...
    opt.outputFile = getExeDir() + "/equinox-48KHz.adif.aac";
}

void help(OptionsConfig<char>& optcfg)
{
    cout << "Usage: enc_aac_adif_file --input <wav file> --output <aac file>" << endl;
    doHelp(cout, optcfg);
}
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    ...
    optcfg.addOptions()
    (("help,h"),    opt.help,                   (""))
    (("input,i"),   opt.inputFile,  string(),   ("input YUV file"))
    (("output,o"),  opt.outputFile, string(),   ("output H264 file"));
