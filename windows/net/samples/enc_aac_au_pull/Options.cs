...
namespace EncAacAuPullSample
{
    class Options
    {
        // enc_aac_au_pull command line options
        ...
        [Option('o', "output", HelpText = "output raw AAC file (without headers)")]
        ...
        void PrintUsage()
        {
            Console.WriteLine("\nUsage: enc_aac_au_pull --input <inputFile.yuv> --output <outputFile.h264>");
