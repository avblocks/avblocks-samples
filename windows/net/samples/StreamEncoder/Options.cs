...
long format:
	streamencoder --frame 352x288 --rate 30 --color yuv420 --input file.yuv --output output.mpg --preset ipad.mp4.h264.720p

short format:
	streamencoder -f 352x288 -r 30 -c yuv420 -i file.yuv -o output.mpg -p ipad.mp4.h264.720p
*/
...
namespace StreamEncoderSample
{
    class Options
    {
        // StreamEncoder command line options
        ...
        {
            Console.WriteLine(
                "\nUsage: streamencoder --frame <width>x<height> --rate <fps> --color <COLOR> --input <file> --output <file> " +
