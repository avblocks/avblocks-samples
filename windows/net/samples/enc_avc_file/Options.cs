...
short format:
 *  enc_avc_file -i <inputFile.yuv> -o <outputFile.h264> --r 30 -f 176x144 -c yuv420
long format:
	enc_avc_file --input <inputFile.yuv> --output <outputFile.h264> --rate 30 --frame 176x144 --color yuv420
*/

namespace EncAvcFileSample
{
    class Options
    {
        ...
        void PrintUsage()
        {
            Console.WriteLine("\nUsage: enc_avc_file --input <inputFile.yuv> --output <outputFile.h264> --rate 30 --frame 176x144 --color yuv420");
