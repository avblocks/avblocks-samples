...
namespace HwEncAvcIntelFileSample
{
    class Program
    {
        static int Main(string[] args)
        {
            ...
            if (!IsHardwareEncoderAvailable(HwVendor.Intel, HwCodecType.H264Encoder))
            {
                Console.WriteLine("Intel H.264 hardware encoder is not available on your system");
                return 0;
            }
        ...
        static MediaSocket CreateOutputSocket(Options opt)
        {
            ...
            pin.Params.Add(Param.HardwareEncoder, HardwareEncoder.Intel);
