...
short format:
 *  enc_avc_push -i <inputFile.yuv> -o <outputFile.h264> --r 30 -f 176x144 -c yuv420
long format:
	enc_avc_push --input <inputFile.yuv> --output <outputFile.h264> --rate 30 --frame 176x144 --color yuv420
*/
...
namespace EncAvcPushSample
{
    class Options
    {
        ...
        void PrintUsage()
        {
            Console.WriteLine("\nUsage: enc_avc_push --input <inputFile.yuv> --output <outputFile.h264> --rate 30 --frame 176x144 --color yuv420");
        ...
        void SetDefaultOptions()
        {
            ...
            Console.Write("enc_avc_push --input " + InputFile);
        ...
        static ColorDescriptor[] Colors = {
	        ...
	        new ColorDescriptor( ColorFormat.BGR32,	    "bgr32",	"Composite B->G->R->A" ),
