...
namespace EncAacAdifFileSample
{
    class Options
    {
        // enc_aac_adif_file command line options
        ...
        void PrintUsage()
        {
            Console.WriteLine("\nUsage: enc_aac_adif_file --input <wav file> --output <aac file>");
        ...
        void SetDefaultOptions()
        {
            ...
            OutputFile = Path.Combine(exeDir, "equinox-48Khz.adif.aac");
