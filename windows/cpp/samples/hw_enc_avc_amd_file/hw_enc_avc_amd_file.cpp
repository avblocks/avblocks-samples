...
primo::ref<MediaSocket> createOutputSocket(Options& opt)
{
    ...
    pin->params()->addInt(Param::HardwareEncoder, HardwareEncoder::AMD);
...
int wmain(int argc, wchar_t* argv[])
{
    ...
    if (!isHardwareEncoderAvailable(primo::codecs::HwVendor::Amd, primo::codecs::HwCodecType::H264Encoder))
    {
        wcout << "AMD H.264 hardware encoder is not available on your system" << endl;
        return 0;
    }
