...
void setDefaultOptions(Options& opt)
{
	...
	opt.h264_file = getExeDir() + L"\\foreman_qcif.h264";
...
{
	wcout << L"hw_enc_avc_intel_file --frame <width>x<height> --rate <fps> --color <COLOR> --input <file.yuv> --output <file.h264>" << endl
			<< L"[--colors]" << endl;
	doHelp(wcout, optcfg);
}
