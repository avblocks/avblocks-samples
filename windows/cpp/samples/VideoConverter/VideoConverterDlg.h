...
class CVideoConverterDlg : public CDialog, public primo::avblocks::TranscoderCallback
{
// Construction
public:
	CVideoConverterDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_VIDEOCONVERTER_DIALOG };
