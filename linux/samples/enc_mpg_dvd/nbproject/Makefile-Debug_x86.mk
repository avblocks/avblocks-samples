...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/end_mpg_dvd.app

../../lib/end_mpg_dvd.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/end_mpg_dvd.app ${OBJECTFILES} ${LDLIBSOPTIONS}
