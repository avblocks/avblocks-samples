...
void setDefaultOptions(Options& opt)
{
    ...
    cout << opt.inputFile << endl;
    opt.outputFile = getExeDir() + "/equinox-48KHz.au.aac";
}

void help(OptionsConfig<char>& optcfg)
{
    cout << "enc_aac_au_pull --input <wav file> --output <aac file>" << endl;
    doHelp(cout, optcfg);
}
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    ...
    (("output,o"),  opt.outputFile,  string(),   ("output raw AAC file (without headers)"));
