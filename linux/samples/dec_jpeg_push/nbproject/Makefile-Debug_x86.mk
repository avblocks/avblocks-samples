...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/dec_jpeg_push_d.app

../../lib/dec_jpeg_push_d.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/dec_jpeg_push_d.app ${OBJECTFILES} ${LDLIBSOPTIONS}
