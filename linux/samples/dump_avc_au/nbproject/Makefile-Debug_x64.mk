...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/dump_avc_au64d.app

../../lib/dump_avc_au64d.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/dump_avc_au64d.app ${OBJECTFILES} ${LDLIBSOPTIONS}
