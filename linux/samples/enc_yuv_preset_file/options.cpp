...
{
    cout << "\nUsage: enc_yuv_preset_file --frame <width>x<height> --rate <fps> --color <COLOR> --input <yuv-file> --output <file> [--preset <PRESET>]";
    cout << " [--colors] [--presets]";
    cout << endl;
...
void setDefaultOptions(Options& opt)
{
    ...
    opt.preset = *getPresetByName(primo::avblocks::Preset::Video::iPad::H264_720p);
}
