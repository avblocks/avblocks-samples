...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/overlay_yuv_jpegs_push_pulld.app

../../lib/overlay_yuv_jpegs_push_pulld.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/overlay_yuv_jpegs_push_pulld.app ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../lib/overlay_yuv_jpegs_push_pulld.app
