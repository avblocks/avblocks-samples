...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/enc_mp4_avc_aac_push64.app

../../lib/enc_mp4_avc_aac_push64.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/enc_mp4_avc_aac_push64.app ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../lib/enc_mp4_avc_aac_push64.app
