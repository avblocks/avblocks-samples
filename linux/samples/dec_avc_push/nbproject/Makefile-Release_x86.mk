...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/dec_avc_push.app

../../lib/dec_avc_push.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/dec_avc_push.app ${OBJECTFILES} ${LDLIBSOPTIONS}
