...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../lib/enc_avc_push64d.app

../../lib/enc_avc_push64d.app: ${OBJECTFILES}
	${MKDIR} -p ../../lib
	${LINK.cc} -o ../../lib/enc_avc_push64d.app ${OBJECTFILES} ${LDLIBSOPTIONS}
